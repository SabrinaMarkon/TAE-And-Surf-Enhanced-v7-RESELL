...
<div style="color:#000;font-size:18px;font-weight:bold;">come with the Enhanced Advertise & Surf TAE (Text Ad Exchange) v7.1 PHP 5.4 Compatible Script!!</div>
<br><br>
<a href="http://demotaeenhancedv7.phpsitescripts.com/admin" target="_blank"><img src="http://phpsitescripts.com/images/demo.png" border="0"></a>
<br><br><br>
Please check out our interactive DEMO of the Enhanced Advertise & Surf TAE (Text Ad Exchange) v7.1 PHP 5.4 Compatible Script as an admin <a href="http://demotaeenhancedv7.phpsitescripts.com/admin" target="_blank">HERE</a> (admin login details are already in the login form for you). <br><br>Examine our DEMO site as a member <a href="http://demotaeenhancedv7.phpsitescripts.com/memberlogin.php" target="_blank">HERE</a> (demo member details are already in the login form)</b><br><br>
...
<tr><td colspan="2" align="center"><br><font size="6" color="ff0000">Buy This Enhanced Advertise & Surf TAE (Text Ad Exchange) v7.1 PHP 5.4 Compatible Script Now For Only $44.99!</font></td</tr>
<form action="http://phpsitescripts.com/sales_order.php" method="post">
<tr><td align="right">Licence:</td><td>Unlimited Multiple Site License with Resell Rights for Enhanced Advertise & Surf TAE (Text Ad Exchange) v7.1 PHP 5.4 Compatible Script</td></tr>
...
<input type="hidden" name="order_script" value="textadexchange_enhanced_v7.1">
