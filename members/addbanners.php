...
if($userid != "") {
    ...
    if ($done == "YES") {
        ...
        $query3 = "select * from banners where added=1 and userid='".$userid."'";
    	...
    	$query = "SELECT * FROM banners where added=0 and userid='".$userid."' limit 1";
		$result = mysql_query ($query)
			or die ("Query failed");
            ...
            $bannerurl = $line["bannerurl"];
        		...
        		if ($existing == 1) { ?><center>
	                <p><b>To add your credits to an existing campaign:</b></p>
	                   ...
	                   <select name="name">
	                <?
                        $query2 = "select * from banners where added=1 and userid='".$userid."'";
