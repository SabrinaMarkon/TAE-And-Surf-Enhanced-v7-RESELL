...
if($userid != "") {
    ...
    if ($done == "YES") {
		...
		if($_POST['id']) $query = "SELECT * FROM loginads where userid='".$userid."' AND id='".$_POST['id']."' limit 1";
    	else $query = "SELECT * FROM loginads where added=0 and userid='".$userid."' limit 1";
